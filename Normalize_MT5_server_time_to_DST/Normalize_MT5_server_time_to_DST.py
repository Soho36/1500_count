...
def main():
    # Configuration
    input_file = 'C:\YandexDisk\Desktop_Zal\MNQ_History_files\Contionuous_merged\merged_files_outputs\MNQ_merged_no_spread.csv'  # Change this to your input file name
    output_file = 'C:\YandexDisk\Desktop_Zal\MNQ_History_files\Contionuous_merged\merged_files_outputs\MNQ_merged_no_spread_DST_adjusted.csv'  # Output file name
